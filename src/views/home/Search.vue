    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 搜索管理
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
...
import { updateSearch, addSearch, deleteSearch, getSearchPage } from "../../api/index";
    ...
    setup() {
        ...
        const handleDelete = (index,res) => {
            ...
            ElMessageBox.confirm("确定要删除吗？", "提示", {
                ...
                .then(() => {
                    console.log(res.id);
                    deleteSearch(deleteData).then((res)=>{
        ...
        const saveEdit = () => {
            updateSearch(updateform).then((res)=>{
                if(res.errorCode == 200){
