    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                <el-input v-model="query.name" placeholder="角色名" class="handle-input mr10" clearable></el-input>
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header">
                ...
                <el-table-column prop="roleDec" label="权限描述"></el-table-column>
        ...
        <el-dialog title="编辑" v-model="editVisible" width="30%">
            <el-form label-width="70px">
                ...
                <el-form-item label="角色描述">
                    <el-input v-model="updateform.roleDec"></el-input>
                </el-form-item>
...
import { updateRole, addRole, deleteRole, getRolePage } from "../../api/index";
...
export default {
    ...
    setup() {
        ...
        const saveEdit = () => {
            updateRole(updateform).then((res)=>{
                console.log(res.message);
                if(res.errorCode == 200){
