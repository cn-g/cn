    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 操作管理
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="handle-box">
                <el-input v-model="query.name" placeholder="操作名" class="handle-input mr10" clearable></el-input>
        ...
        <el-dialog title="添加" v-model="addEditVisible" width="30%">
            ...
            <template #footer>
                <span class="dialog-footer">
                    ...
                    <el-button type="primary" @click="addOperateEdit">确 定</el-button>
                </span>
            </template>
        </el-dialog>
    </div>
...
import { updateOperate, addOperate, deleteOperate, getOperatePage } from "../../api/index";
...
export default {
    ...
    setup() {
        ...
        const saveEdit = () => {
            updateOperate(updateform).then((res)=>{
                if(res.errorCode == 200){
