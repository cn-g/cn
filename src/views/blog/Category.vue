    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 类目管理
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="handle-box">
                <el-input v-model="query.name" placeholder="类目名称" class="handle-input mr10" clearable></el-input>
        ...
        <el-dialog title="添加" v-model="addEditVisible" width="30%">
            ...
            <template #footer>
                <span class="dialog-footer">
                    ...
                    <el-button type="primary" @click="addCategoryEdit">确 定</el-button>
                </span>
            </template>
        </el-dialog>
    </div>
...
import { updateCategory, addCategory, deleteCategory, getCategoryPage } from "../../api/index";
...
export default {
    ...
    setup() {
        ...
        // 获取表格数据
        const getData = () => {
            getCategoryPage(query).then((res) => {
